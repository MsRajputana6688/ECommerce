...
const ShowCart = ({ id, name, star, price, img, Stock, brand, Sold, setShow, AddCart }) => {
            ...
            <div className="pop-card">
                ...
                <div className="pop-card-top">
                    ...
                    <div className="pop-card-info">
                        ...
                        <div className="rated">Rated:&nbsp;&nbsp;
                            {
                                star.map((val) => {
                                    if (val == 1) {
                                        return (
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="100%" viewBox="0 0 24 24" fill="#FFCD4E" stroke="#FFCD4E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-star">
                                                <defs>
                                        ...
                                        return (
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="100%" viewBox="0 0 24 24" fill="none" stroke="#FFCD4E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-star">
                                                <defs>
                                                    <linearGradient id="star-0.9242489162248262">
                                                        <stop offset="1" stopColor="#FFCD4E"></stop>
                                                        <stop offset="1" stopColor="#FFFFFF" stopOpacity="1"></stop>
                        ...
                        <button type='button' className="btn" onClick={() => AddCart(id)}>Add to Cart</button>
